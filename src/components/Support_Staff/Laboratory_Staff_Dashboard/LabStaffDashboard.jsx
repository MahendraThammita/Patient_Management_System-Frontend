...
import AppointmentChart from '../Nurse_Dashboard/AppointmentChart'
import CollectionsChart from '../Nurse_Dashboard/CollectionsChart'
import OverviewCard from '../DashboardCommon/OverviewCard'
import JobQueueComponant from './JobQueueComponant'
import LabTestChartComponant from './LabTestChartComponant'
...
export default class LabStaffDashboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            form: Form
