...
export default class EditTest extends Component {
    ...
    fetchTests = () =>{
        console.log('selTest mm: ' , window.localStorage.getItem('selected_labTest'))
        fetch('http://localhost:8090/tests/getByIdForStaff/'+window.localStorage.getItem('selected_labTest'))
        .then(res => res.json()).then(data =>{
            console.log('Res compleated' , data)
          this.setState({appointment: data.data[0] , 
            ...
            testCategoryObjectsArray:data[0].results,
            specialRemarks:data[0].specialRemarks});

            console.log('after fetch');
          console.log('result is : ' , data[0].results);
                                ...
                                <Col span={18}>
                                    ...
                                    >
                                        ...
                                        <Row>
                                            ...
                                            >
                                                <Input.TextArea style={{ width: 540 }} defaultValue={this.state.specialRemarks}/>
                                            </Form.Item>
                                        </Row>
                                        <Row>
                                            <Col span={5}></Col>
